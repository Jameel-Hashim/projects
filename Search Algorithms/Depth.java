...
class Depth
{
	...
	protected Depth(Character symbols[], int goal)
	{
    ...
    private ArrayList<Integer> shift(ArrayList<Integer> tmp_array, ArrayList<Integer> array)
    {
    	ArrayList<Integer> new_array = new ArrayList<Integer>();

    	for(int i=0 ; i<tmp_array.size() ; i++)
    		new_array.add(tmp_array.get(i));
